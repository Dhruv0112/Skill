...
import customer1 from '../images/customers/customer.svg';
import customer2 from '../images/customers/customer1.svg';
                            ...
                            <div className="carousel-inner card border-0 shadow-lg p-4">
                                ...
                                <div className="carousel-item text-center">
                                    <div className="row">
                                        ...
                                        <div className="col-md-4 col-12 my-auto">
                                            <div className="text-dark">
                                                <h3 className="font-weight-bolder ">Customer Ashish</h3>
                ...
                <div className="col-md-4 col-12 mx-auto my-2">
                    <div className="card border-0 shadow-lg p-4">
                        ...
                        <div className="card-body">
                            ...
                            <div className="card-text text-black-50">CEO DHRUV AGRAWAL<p className="float-right">4 years</p>
                            </div>
